...
static int box[3][4] = { { 0, 0, 66, 10 }, { 66, 0, 66, 10 }, { 88, 12, 44, 10 } };
int nBoxes = 3;
...
void printCorrection() {
  displayText(formatCorrectionValue(correctionValue), 2, currentMode == CORRECTION);
}
